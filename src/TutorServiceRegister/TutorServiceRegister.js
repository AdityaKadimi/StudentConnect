...
registerService =() =>{
  ...
  from_date=   dateFormat(from_date, "yyyy-MM-dd'T'HH:mm:ss.SSS'Z'");
  console.log(from_date);

   //from_date = new Date(from_date);
   //to_date = new Date(to_date);
  to_date = dateFormat(to_date, "yyyy-MM-dd'T'HH:mm:ss.SSS'Z'");
  console.log(to_date);
...
//registerTutorService(this.props.userId,this.state.topicId,this.state.classSize,weekDay,to_date,from_date,this.state.serviceType)
