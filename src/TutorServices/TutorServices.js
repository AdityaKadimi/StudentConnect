...
export default class TutorServices extends Component {
  ...
  render() {
    ...
    return (
      <div>
    <Link  to = "/student">  <button className="btn btn-primary" id ="studentdash" disabled = {userType == 'T'} >Student Dashboard</button></Link>
    <button className="btn btn-primary" onClick = {this.studentRegister} disabled = {userType == 'B'} id = "studentreg">Student Register</button>
    <button className="btn btn-primary" id = "servicereg" onClick = {this.showServiceRegister}>Service Register</button>
    <Link to = '/'><button className="btn btn-secondary" id = "logouttutor" >Logout</button></Link>
